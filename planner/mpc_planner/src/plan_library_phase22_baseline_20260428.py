...
PLAN_LEFT_PASS = {
    ...
    'weights': {
        ...
        'w_obs':       80.0,    # Phase 2-2: 100→80 (target_n 추가, 일부 줄임)
        'sigma_n_obs': 0.60,
        'q_n_term':    10.0,
        'q_n':         3.0,     # N=20 baseline 유지
        'q_n_ramp':    14.0,
        'w_cont':      300.0,
        'gamma_progress': 13.0,
...
PLAN_TRAIL = {
    ...
    'weights': {
        'w_side_bias': 0.0,
        'w_obs':       40.0,    # N=20: 50→40 (target_n 이 주 가이드)
        'sigma_n_obs': 0.40,
        'q_n_term':    3.0,     # N=20 baseline (1.5 → 3.0 복귀)
        'q_n':         1.0,     # N=20 baseline (0.5 → 1.0 복귀)
        'q_n_ramp':    0.0,
        'w_cont':      250.0,
        'gamma_progress': 8.0,
