...
class StateMachine:
    ...
    def __init__(self, name) -> None:
        ...
        self.smart_static_active = False  # kept for compatibility (always False)
        ...
        if self.ot_planner == "spliner" or self.ot_planner == "predictive_spliner":
            # #avoidance_cb disabled — _ot_iy_cb handles this topic
    ...
    def loop(self):
        ...
        # OT path injection
        if self._ot_iy_wpnts is not None and self.cur_state in (StateType.OVERTAKE, StateType.TRAILING):
            local_wpnts = []  # will be filled below
        else:
