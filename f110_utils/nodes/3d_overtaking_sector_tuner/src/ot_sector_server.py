...
# origin: from overtaking_sector_tuner.cfg import ot_dyn_sect_tunerConfig
## IY : use self-contained 3D Config
from overtaking_sector_tuner_3d.cfg import ot_dyn_sect_tuner_3dConfig as ot_dyn_sect_tunerConfig
